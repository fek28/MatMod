...
subtitle: "Модель хищник-жертва - вариант 62"
...
$$
 \begin{cases}
	\frac{dx}{dt} = (-0.57x(t) + 0.047y(t)x(t))
	\\   
	\frac{dy}{dt} = (0.37y(t) - 0.027y(t)x(t))
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=36, y_0=11$
...
Стационарное состояние $x_0=12.128, y_0=19.704$
