...
subtitle: "Модель гармонических колебаний - вариант 62"
...
силы $\ddot{x}+6\dot{x}+5x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+10\dot{x}+9x=8\sin{7t}$

На итнтервале $t \in [ 0;80 ]$, шаг 0.05, $x_0=0.8, y_0=-1.2$
